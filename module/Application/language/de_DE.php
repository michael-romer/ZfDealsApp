...
return array(
    // Admin Layout
    "ZfDeals - Administration" => "ZfDeals - Administration",
    "Home" => "Startseite",
    ...
    "Show active Deals" => "Aktuelle Deals ansehen",

    // Site Layout
    "ZfDeals" => "ZfDeals",

    // Product Add Error
    "Product could not be added." => "Produkt konnte nicht hinzugefügt werden.",
    "Product added!" => "Produkt hinzugefügt!",

    // Product Fieldset
    "Product-ID" => "Produkt-ID",
    "Product label" => "Produktbezeichnung",
    "Trading stock" => "Warenbestand",
